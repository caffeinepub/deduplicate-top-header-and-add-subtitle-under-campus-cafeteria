...
import { Clock, CheckCircle2, ChefHat, Package, Eye, Banknote, Smartphone } from 'lucide-react';
...
export default function AllOrdersManagement({ orders: initialOrders }: AllOrdersManagementProps) {
                ...
                <Card key={order.id}>
                  ...
                  <CardContent className="space-y-3">
                    <div className="flex items-center justify-between rounded-lg bg-gray-50 p-3">
                      ...
                      <span className="text-sm text-muted-foreground">{itemsSummary}</span>
                    </div>
